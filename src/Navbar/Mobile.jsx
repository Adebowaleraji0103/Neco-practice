...
const Mobile = () => {
  ...
  return (
    <div>
      ...
      />
      {menuIsOpen && (
        <div className="z-50 top-0 left-0 flex justify-between  w-full h-full text-[14px] fixed bg-gray-800/95 inset-0 text-white md:hidden">
          ...
          <div className="flex flex-col gap-10 w-[65%] bg-white px-3 pt-[3.5rem] text-black text-[25px] ">
            ...
            <button className="bg-gray-800 text-white text-[16px] w-fit py-1 px-2 rounded-[5px] flex">
              Login
            </button>
          </div>
        </div>
