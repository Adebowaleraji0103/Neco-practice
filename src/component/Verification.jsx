const Verification = () => {
  return (
    <div className="mb-90 flex flex-col gap-[2rem] text-center padding bg-[#054C0F] text-white font-semibold ">
      <h2 className="font-bold text-[28px] ">e-Verify Online Result Verification/Confirmation Solution</h2>
