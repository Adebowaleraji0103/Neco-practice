const Verification = () => {
  return (
    <div className="mb-90 flex flex-col justify-center gap-[2rem] py-[7rem] px-[1rem] md:px-[6rem] text-center bg-[#054C0F] text-white font-semibold mt-[4rem] md:text-[20px] md:flex-row md:gap-[4rem] md:text-start md:items-center">
      ...
      <div className="flex flex-col items-center gap-5 px-[1.5rem] md:w-[40%] md:text-start md:items-start">
        ...
        <button className="bg-white text-[#054C0F] w-fit py-5 px-9 rounded-[6px] cursor-pointer">Apply here</button>
      </div>
    </div>
  );
};
