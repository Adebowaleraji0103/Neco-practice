const Verification = () => {
  return (
    <div className="mb-[3rem] flex flex-col justify-center gap-[2rem] py-[7rem] px-[1rem] md:px-[6rem] text-center bg-[#054C0F] text-white font-semibold mt-[4rem] md:text-[20px] md:flex-row md:gap-[4rem] md:text-start md:items-center">
